...
- **System Sync**: Initial load respects your system's dark mode preference.
...
**Built by [Antigravity](https://github.com/google-deepmind) for the next generation of financial disruptors.**
